...
public class ViaEvent : AggregateRoot<ViaEventId>
{
    ...
    private ViaEvent(ViaEventId id, ViaEventTitle title, ViaEventDescription description, ViaStartDate startDate,
        ViaEndDate endDate, ViaMaxGuests maxGuests)
        : base(id)
    {
        _title = title;
    ...
    public static OperationResult<ViaEvent> Create(ViaEventId id, ViaEventTitle title, ViaEventDescription description,
        ViaStartDate startDate, ViaEndDate endDate, ViaMaxGuests maxGuests)
    {
